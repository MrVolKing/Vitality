...
$(".tanci_btn3").on('click', function() {
	...
	$(".custom_text").append(`<img style="display: block; margin: 0 auto;" src="http://qrcoder.ru/code/?http%3A%2F%2Fhappy-birthday-irineira.000webhostapp.com%2Fprize.html&4&0" width="148" height="148" border="0" title="QR код">`)
...
$(".go_danet").on('click', function() {
	...
	if(inp.value == "1313"){  
		...
		var ti = document.querySelector(".inp_danet").style.display = "none";
		var tb = document.querySelector(".go_danet").style.display = "none";
...
$(".button_ver1").on('click', function() {
	...
	console.log("do 88");
	let tr = document.querySelector(".predfinal .wp").textContent = "88%";
	console.log("88");
	let inn = document.querySelector(".predfinal .progress__inner").style.width = "88%"; 
...
$(".button_ver2").on('click', function() {
	...
	let tr = document.querySelector(".predfinal .wp").textContent = "91%";
	let inn = document.querySelector(".predfinal .progress__inner").style.width = "91%"; 
...
$(".button_ver3").on('click', function() {
	...
	let tr = document.querySelector(".predfinal .wp").textContent = "94%";
	let inn = document.querySelector(".predfinal .progress__inner").style.width = "94%"; 
...
$(".button_never4").on('click', function() {
	...
	let tr = document.querySelector(".predfinal .wp").textContent = "97%";
	let inn = document.querySelector(".predfinal .progress__inner").style.width = "97%"; 
...
$(".button_ver5").on('click', function() {
	...
	let inn = document.querySelector(".final .progress__inner").style.width = "100%"; 
...
// PODAROK
// $(".big_podarok").on('click', function() {
	
// 	let txt = document.querySelector(".custom_text").remove();
// 	// let c_i = document.querySelector(".custom_img").setAttribute("src", "./images/stir.png");
...
// 	// img.setAttribute("src", "./images/stir.png");

// 	// custom_popap

// 	$(".custom_popap").append(`<div><img src="./images/icn/close.png" class="custom_close"><img class="palma2" src="./images/stir.png"></div>`);
...
// let rcs = document.querySelector(".content");
// rcs.nextElementSibling.nextElementSibling.nextElementSibling.style.opacity = "0";